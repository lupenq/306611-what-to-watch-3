    ...
    <div className="movie-card__wrap">
      <div className="movie-card__info">
        ...
        <div className="movie-card__desc">
          <h2 className="movie-card__title">{props.promoSettings.name}</h2>
          <p className="movie-card__meta">
            <span className="movie-card__genre">{props.promoSettings.genre}</span>
            <span className="movie-card__year">{props.promoSettings.date}</span>
          </p>
